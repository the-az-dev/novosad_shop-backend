...
@Entity("article-description", { schema: "novosad-shop" })
export class ArticleDescription {
  ...
  @ManyToOne(() => Article, (article) => article.articleDescriptions, {
    onDelete: "CASCADE",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => TextI18n, (textI18n) => textI18n.articleDescriptions, {
    onDelete: "CASCADE",
    onUpdate: "NO ACTION",
  })
